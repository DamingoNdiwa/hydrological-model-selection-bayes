...
def run_analysis(params):
    ...
    model_prior_params = {
        "n": 4,
        "k": {"loc": jnp.array([0.0, 0.0, 0.0, 0.0]),
              "scale": jnp.array([1.0, 1.0, 1.0, 1.0])},
        "k_int": {"loc": jnp.array([0.0, 0.0, 0.0]),
    ...
    df4.to_csv('meanlogll4bucsrea15.csv', index=False)
    ...
    post_samples.to_csv('post4bucsrea.csv', index=False)

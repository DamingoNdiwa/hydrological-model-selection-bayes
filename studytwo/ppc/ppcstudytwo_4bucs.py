...
model_prior_params = {
        "n": 4,
        "k": {"loc": jnp.array([1.0, 0.6, 0.3, 0.1]),
            "scale": jnp.array([0.25, 0.25, 0.25, 0.25])},
        "k_int": {"loc": jnp.array([0.8, 0.4, 0.1]),
...
# the key 1569 was used to generate the data so as to have decreasing flow rates
# the right model is always chosen irrspective of the key used
...
jnp.save('ppcstudytwo4bucs',posterior_predictive,allow_pickle=True)
print("REMC finished.")

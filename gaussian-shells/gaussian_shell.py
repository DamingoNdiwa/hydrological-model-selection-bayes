...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Calculate the marginal likelihood of the n-dimensional Gaussian shell problem")
    parser.add_argument('--dimension', type=int, nargs='+',
                        help="Number of dimensions", default=2)
    parser.add_argument('--num_chains', type=int, nargs='+',
                        help="Number of chains", default=1)
    parser.add_argument('--num_results', type=int, nargs='+',
                        help="Number of samples", default=100000)
    parser.add_argument('--num_betas', type=int, nargs='+',
                        help="Number of temperatures", default=150)

...
def run_analysis(params):
    ...
    jnp.save('prior_obs2', prior_predictive[-1], allow_pickle=True)
    ...
    post_save.to_csv('post_2bucsrea.csv', index=False)
    ...
    az.to_netcdf(az_trace, 'hbvresult2bucsrea')
    ...
    jnp.save('ppc21bucsrea',posterior_predictive[-1], allow_pickle=True)
